...
process_all_lyrics <- function(daemons_artists = 10, daemons_songs = 5, write_output = FALSE, filename_output = NULL, language = NULL) {
  ...
  lyrics_artists = list.files("outputs/lyrics/", pattern = "json", full.names = TRUE)
  lyrics_songs   = list.files("outputs/lyrics_individual_songs/", pattern = "json", full.names = TRUE)
